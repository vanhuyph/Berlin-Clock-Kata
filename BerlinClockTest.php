...
class BerlinClockTest extends TestCase
{
    ...
    public function test_translateSimpleHours_given0_shouldReturn4O(){
        $actual = $this->actTranslateSimpleHours(0);

        $this->assertEquals("OOOO", $actual);
    }

    public function test_translateSimpleHours_given1_shouldReturn1R3O(){
        $actual = $this->actTranslateSimpleHours(1);

        $this->assertEquals("ROOO", $actual);
    }

    public function test_translateSimpleHours_given2_shouldReturn2R2O(){
        $actual = $this->actTranslateSimpleHours(2);

        $this->assertEquals("RROO", $actual);
    }

    public function test_translateSimpleHours_given3_shouldReturn3R1O(){
        $actual = $this->actTranslateSimpleHours(3);

        $this->assertEquals("RRRO", $actual);
    }

    public function test_translateSimpleHours_given4_shouldReturn4R(){
        $actual = $this->actTranslateSimpleHours(4);

        $this->assertEquals("RRRR", $actual);
    }

    public function test_translateBlockOf5hours_given0_shouldReturn4O(){
    ...
    public function test_translateBlockOf5hours_given10_shouldReturn2R2O(){
        $actual = $this->actTranslateBlockOf5hours(10);

        $this->assertEquals("RROO", $actual);
    }

    public function test_translateBlockOf5hours_given15_shouldReturn3R1O(){
        $actual = $this->actTranslateBlockOf5hours(15);

        $this->assertEquals("RRRO", $actual);
    }

    public function test_translateBlockOf5hours_given20_shouldReturn4R(){
    ...
    {
        return $this->berlinClock->translateSimpleHours($int);
    }
