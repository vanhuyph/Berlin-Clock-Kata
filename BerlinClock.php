...
class BerlinClock
{
    ...
    public function translateSimpleHours(int $minutes): string
    {
        if($minutes%5 === 1) return "ROOO";
        if($minutes%5 === 2) return "RROO";
        if($minutes%5 === 3) return "RRRO";
        if($minutes%5 === 4) return "RRRR";
